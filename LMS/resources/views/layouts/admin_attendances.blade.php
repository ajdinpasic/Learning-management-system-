      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            >
              Here you can enter, update and delete either lab or lecture attendance per class for each user by clicking on the icons (from left to right).
            </h4>
            ...
            >
              ...
              ></path>
                          ...
                          <button
                            class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Edit" onclick="window.open('http://127.0.0.1:8000/admins/{{$user->name}}/edit_grades/{{$course->name}}')" 
                          >
                            <svg
                              class="w-5 h-5"
                              aria-hidden="true"
                          ...
                          <button
                            class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Delete"  onclick="window.open('http://127.0.0.1:8000/admins/{{$user->name}}/delete_grades/{{$course->name}}')" 
                          >
                            <svg
                              class="w-5 h-5"
                              aria-hidden="true"
